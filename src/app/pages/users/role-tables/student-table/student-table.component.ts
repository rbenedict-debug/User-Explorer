...
export class StudentTableComponent implements AfterViewInit, OnDestroy {
  private readonly router = inject(Router);
  private readonly cdr = inject(ChangeDetectorRef);
  private readonly host = inject(ElementRef).nativeElement as HTMLElement;

  private readonly roleSlug = 'student';
  ...
  readonly columns = [
    ...
    { name: 'Grade',           width: 120, type: 'text',   _categorical: true,  _badgeOptions: null },
    ...
    { name: 'Guardian',        width: 180, type: 'text',   _categorical: false, _badgeOptions: null },
