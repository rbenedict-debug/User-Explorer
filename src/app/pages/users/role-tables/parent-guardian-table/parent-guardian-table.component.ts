...
@Component({
  selector: 'app-parent-guardian-table',
  imports: [RouterLink],
  templateUrl: './parent-guardian-table.component.html',
  styleUrl: './parent-guardian-table.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'ds-page-content', role: 'main' },
})
export class ParentGuardianTableComponent implements AfterViewInit, OnDestroy {
  ...
  readonly columns = [
    ...
    { name: 'Phone',           width: 160, type: 'text',   _categorical: false, _badgeOptions: null },
    { name: 'Linked Students', width: 150, type: 'number', _categorical: false, _badgeOptions: null },
